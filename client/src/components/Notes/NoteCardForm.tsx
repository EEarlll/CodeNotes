...
export default function NoteCardForm({ note, pin }: noteCardType) {
  ...
  async function handlePinSubmit() {
    pinMutation.mutate({
      url: `${import.meta.env.VITE_URL}/Notes/${note.id}/pin`,
  ...
  return (
    <>
      <cardForm.Dialog open={open} onOpenChange={setOpen}>
        ...
        >
          ...
          <div className="h-[60vh] md:h-[77vh] overflow-y-scroll scrollbarStyle">
            <NoteCardContent
              formData={formData}
              extension={extension}
                  ...
                  <cardForm.Button
                    ...
                    onClick={async () => {
                      updateMutation.mutate({
                        url: `${import.meta.env.VITE_URL}/Notes/${
                          note.id
                        }/update`,
                        method: "POST",
                        formData,
